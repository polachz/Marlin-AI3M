...
#define STRING_CONFIG_H_AUTHOR "(ZP based on davidramiro, for Anycubic i3 Mega)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //Re-Calibrated for E3Dv6 Triangle lab clone
 ...
 */
 //Extruder modofied to 422 -> BMG -> calibrated
...
#define INVERT_E0_DIR true //BMG Extruder
